...
urlpatterns = [
    ...
    path('Baggage-page',views.Baggage,name="baggage"),
    path('modify_string', views.modify_string, name='modify_string'),
    path('bootsearch', views.bootsearch, name='bootsearch'),
    path('map1',views.map1,name="map1"),
    path('maploc',views.maploc,name="maploc"),
    path('pnr',views.pnr,name="pnr"),
    path('pnrfun',views.pnrfun,name="pnrfun"),
]